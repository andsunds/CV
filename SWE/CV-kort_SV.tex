...
\address{Chalmers tekniska högskola\\
  Insitutionen för fysik\\}{Fysikgården 1}{412 96, Göteborg}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
\phone[mobile]{031-772\,64\,08}                   % optional, remove / comment the line if not wanted; the optional "type" of the phone can be "mobile" (default), "fixed" or "fax"
...
\cventry{maj
  ...
  modellering av kollisionseffekter i laser--plasmor, i synnerhet har
  jag studerat jonacceleration med hjälp av chockvågor.} %
\cventry{aug. 2017}{Amanuens}{Institutionen Elektroteknik, Chalmers
  ...
  elektromagnetik. %
  Jag jobbade med ett projekt att matematisk modellera
  mikrovågsutbredning i vävnad.} %
